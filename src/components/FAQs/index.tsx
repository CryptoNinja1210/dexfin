		...
		<>
			...
			<Accordion allowMultiple margin={'0 auto'} style={{ width: '100%', maxWidth: '600px' }}>
				...
				<AccordionItem>
					...
					<AccordionPanel pb={4}>
						We inflate gas limit of txs on MetaMask by +40% to ensure that there's nothing unexpected that could trigger out-of-gas reverts. This stacks on top of any increase your RPC might apply on gas estimations, along with possible different gas prices between your metamask and our estimation.
						<br />
						<br />
						All this together means that gas number you see on metamask will always be inflated, while in our UI we display the actual gas that the tx will consume. The extra gas that is not used is just refunded to the user when tx executes.
					</AccordionPanel>
				</AccordionItem>
				<AccordionItem>
					<h2>
					...
					<AccordionPanel pb={4}>
						If any of the aggregators we integrate does an airdrop in the future, all swaps made through them would be eligible for their airdrop.
						<br />
					</AccordionPanel>
				</AccordionItem>
				<AccordionItem>
					...
					<AccordionPanel pb={4}>
						Some ETH orders on CowSwap might not get filled because price moves against you too quickly, in those cases the ETH just sits in a contract until it is refunded 30 minutes after your tx.
					</AccordionPanel>
				</AccordionItem>
			</Accordion>
		</>
